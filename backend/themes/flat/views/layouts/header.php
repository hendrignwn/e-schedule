...
<div id="navigation">
		<div class="container-fluid">
			...
			<div class="user">
				...
				<div class="dropdown">
					<a style="padding:11px 12px;" href="#" class="dropdown-toggle" data-toggle="dropdown">Hi <?=Yii::$app->user->getName()?>&nbsp;&nbsp;<i class="fa fa-user"></i></a>
					<ul class="dropdown-menu pull-right">
						<li>
							<?=Html::a('Edit Profile', Url::toRoute('site/edit-profile'))?>
						</li>
						<li>
							<?=Html::a('Account Settings', Url::toRoute('site/edit-profile'))?>
						</li>
						<li>
						<?php
