<div id="navigation">
		<div class="container-fluid">
			...
			<?=\backend\components\MyController::mainMenu();?>
			<div class="user">
				<ul class="icon-nav">
					<li class='dropdown'>
				...
				<div class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Hi <?=Yii::$app->user->getName()?>
						<img src="<?=$this->theme->getUrl('img/demo/user-2.jpg')?>" alt="">
					</a>
					<ul class="dropdown-menu pull-right">
						<li>
