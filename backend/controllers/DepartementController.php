...
use backend\models\DepartementSearch;
...
class DepartementController extends MyController
{
    ...
    public function actionCreate()
    {
		...
		$faculties = Faculty::find()->actived()->all();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Departement",
                    'content'=>'<span class="text-success">Create Departement success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Departement model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Departement model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
